...
class Wfs {
 ...
 //   this.fileLoader.destroy();
  ...
  // }
  attachMedia(media, opts) { // 'H264Raw' 'FMp4'
    opts = opts || {};
    this.media = media;

    this.mediaType = opts.mediaType || 'H264Raw';
    this.nDllNum = opts.nDllNum;
    this.strIp = opts.strIp;
    this.nPort = opts.nPort;
    this.strUser = opts.strUser;
    this.strPasswd = opts.strPasswd;
    this.nChannel = opts.nChannel;
    this.nSubChannel = opts.nSubChannel;
    this.serverIp = opts.serverIp;
    this.serverPort = opts.serverPort;
    this.websocketName = opts.websocketName;
